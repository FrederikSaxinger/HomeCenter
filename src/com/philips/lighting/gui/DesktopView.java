...
public class DesktopView extends JFrame {
	...
	private JButton grundrissAnsichtButton;
	...
	public DesktopView() {
		...
		grundrissAnsichtButton = new JButton("Grundriss");
		grundrissAnsichtButton.setEnabled(false);
		grundrissAnsichtButton.addActionListener(new ActionListener() {
		...
		double border = 10;
		double size[][] = { { border, 120, 10, 160, 10, 140 }, // Columns
				{ border, 20, 5, 20, 20, 20, 5, 20, 20, 20 } }; // Rows
		...
		// Application to control your Hue Lights."),
		// BorderLayout.NORTH);
	...
	public JButton getGrundrissButton() {
		return grundrissAnsichtButton;
	}
}